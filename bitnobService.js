...
class BitnobService {
    ...
    async getCardById(cardId) {
        try {
            ...
            const response = await axios.get(
                `${BITNOB_BASE_URL}/api/v1/cards/${cardId}`,
                { headers }
            );
    ...
    async freezeCard(cardId, reason = "User requested") {
        ...
        try {
            ...
            const response = await axios.post(
                `${BITNOB_BASE_URL}/api/v1/cards/freeze`,
                payload,
                { headers }
            );
    ...
    async unfreezeCard(cardId, reason = "User requested") {
        ...
        try {
            ...
            const response = await axios.post(
                `${BITNOB_BASE_URL}/api/v1/cards/unfreeze`,
                payload,
                { headers }
            );
    ...
    async getCardTransactions(cardId, limit = 50) {
        try {
            ...
            const response = await axios.get(
                `${BITNOB_BASE_URL}/api/v1/cards/${cardId}/transactions?limit=${limit}`,
                { headers }
            );
    ...
    async terminateCard(cardId, reason = "User requested") {
        ...
        try {
            ...
            const response = await axios.post(
                `${BITNOB_BASE_URL}/api/v1/cards/terminate`,
                payload,
                { headers }
            );
